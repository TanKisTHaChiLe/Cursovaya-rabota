...
//     Q_OBJECT
// public:
//     explicit DatabaseManager(QObject *parent = nullptr); // Конструктор

//     // Методы для работы с пользователями
//     Q_INVOKABLE bool registerUser(const QString &username, const QString &password);
//     Q_INVOKABLE int authenticateUser(const QString &username, const QString &password);
...
// public:
//     explicit DatabaseManager(QObject *parent = nullptr); // Конструктор
//     ~DatabaseManager(); // Деструктор для правильного закрытия соединения

//     // Методы для работы с пользователями
//     Q_INVOKABLE bool registerUser(const QString &username, const QString &password);
//     Q_INVOKABLE bool authenticateUser(const QString &username, const QString &password); // Изменен тип возвращаемого значения на bool
//     Q_INVOKABLE void logoutUser(); // Раскомментирован метод выхода
...
//     bool startPostgresProcessManually(); // Новый метод
//     QString hashPassword(const QString &password);
...
//     QString getPostgresInstallPath() const; // Новый метод
// #endif
// };
