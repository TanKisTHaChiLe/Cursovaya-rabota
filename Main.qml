...
Window {
    ...
    minimumWidth: 700
    visible: true
    title: qsTr("CRM-System")


    StackView {
        id: stackView
        anchors.fill: parent
        initialItem: autorisation
    }
    ...
    // property color body_Background: isDarkTheme ? "#111827" : "#F2F4F4"
    // property color block_Background: isDarkTheme ? "#1F2937" :  "#FFFFFF"
    ...
    //             border.color: isDarkTheme ? "#110000" : "#000000"
    //             border.width: 1
    //             radius: 4
    //             color: isDarkTheme ? "#131927" : "#000000"
    //             function calculateButtonColor() {
    //                 buttonColor = isDarkTheme ? "#131927" : "#000000"
    //                 hoverColor= isDarkTheme ? "#4B5563" :"#1F2937"
    //                 color = buttonColor
    //             }
    ...
    //             border.width: 1
    //             function calculateButtonColor() {
    //                 buttonColor = isDarkTheme ? "#374151" : "#FFFFFF"
    //                 hoverColor= isDarkTheme ? "#4B5563" :"#F3F4F6"
    //                 color = buttonColor
    //             }
    //             property color buttonColor
    //             property color hoverColor
